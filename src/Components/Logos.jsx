    ...
    >
      <g>
        <path
          ...
          d="M416.9,221.3c-4.9,25.5-21.3,44.3-46.2,52.9c-0.5,0.2-1,0.3-1.5,0.5c-2.9,0.9-3,1.1-3.1,1.9
        ...
        <path
          className="leelo-main"
          d="M310.9,309.7c-50.5,50.7-147.4,52.9-200.2,4.6c-35.3-32.3-36.2-78.7-2-112.2c28.3-27.7,63.1-38.8,102.5-39.6
		c36.2,0.6,69.8,10.2,97.4,35.6C343.5,230.2,344.2,276.2,310.9,309.7z"
        />
        <path
          className="leelo-main"
          d="M211,91.3c-16.5,0-28.9-12.4-28.9-28.7c0-16.6,13.3-30.1,29.4-29.8c15.6,0.2,29,13.5,29.3,29.2
		C241,78.2,227.7,91.3,211,91.3z"
        />
        <path
          className="leelo-main"
          d="M70.2,174.9c1.9,0.3,5.2,0.5,8.3,1.4c10.2,2.9,10.7,4.7,3.9,13.1c-10.6,13.2-18.5,27.8-22.2,44.2
		c-1.9,8.3-4.9,7-10.1,3.8c-12.6-7.8-18.7-23.5-14.5-37.7C40.1,185,53.8,174.7,70.2,174.9z"
        />
        <path
          className="leelo-main"
          d="M349.3,174.9c15.4,0.2,28.2,9.6,33,23.5c4.5,13.1,0,28.5-10.7,37.3c-5.1,4.1-8.7,6.3-10.5-3.1
        ...
        <path
          ...
          d="M161.8,276.5c-12.3-0.1-21.9-10-21.5-22.3c0.4-11.5,10.5-21.2,21.9-21c12.2,0.2,21.9,10.4,21.4,22.5
		C183.2,267.7,173.8,276.6,161.8,276.5z"
        />
        <path
          className="leelo-eyes"
          d="M259,276.5c-12.1-0.2-21.1-9.4-21-21.6c0.1-12,9.5-21.5,21.3-21.5c12.4,0,22,9.9,21.7,22.3
		C280.6,267.6,271,276.6,259,276.5z"
        />
        <g>
          <path
            className="leelo-outline"
            d="M336.9,148.4c-21.9,6.7-38.8,7.6-60.2-1.8c-34.6-15.3-72-14.6-109-6.9c-4.5,0.9-8,0-10.2-4
...
export function DefaultRedditIcon(props) {
  const { styles } = props;
  return (
    <svg
      className={styles}
